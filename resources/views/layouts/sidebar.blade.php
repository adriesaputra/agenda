...
<div class="logo-brand mt-lg-5">
    <img src="{{ asset('images/logo-rohul.png') }}" alt="Logo Shoso" width="52" />
    <div>
        <h6 class="title-store">AGENDA KEGIATAN</h6>
        <p class="tagline-store">Bupati & Wakil Bupati</p>
    </div>
</div>
<hr />
<nav class="menu flex-fill">
    <div class="section-menu">
        <a href="{{ route('dashboard') }}" class="item-menu {{ request()->routeIs('dashboard') ? 'active' : '' }}">
        ...
        <a href="{{ route('admin.pejabat.index') }}"
            class="item-menu {{ request()->routeIs('admin.pejabat*') ? 'active' : '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <a href="{{ route('admin.protokol.index') }}"
            class="item-menu {{ request()->routeIs('admin.protokol*') ? 'active' : ''  }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <a href="{{ route('admin.liputan.index') }}"
            class="item-menu {{ request()->routeIs('admin.liputan*') ? 'active' : ''  }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <div class="section-menu">
        <p class="fs-18 fw-500 mb-2">Agenda</p>

        <a href="{{ route('admin.agenda.create') }}"
            class="item-menu {{ request()->routeIs('admin.agenda.create') ? 'active' : '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <a href="{{ route('admin.agenda.index') }}"
            class="item-menu {{ request()->routeIs('admin.agenda.index') ? 'active' : '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <div class="section-menu">
        ...
        <a href="{{ route('profile.edit') }}"
            class="item-menu {{ request()->routeIs('profile.edit') ? 'active' : '' }}">
...
<footer>
    <div class="d-flex gap-3 align-items-center mb-4">
        <img src="{{ asset('images/icons/ic_mode.svg') }}" alt="Mode Display" />
        ...
        <div>
            ...
            <label for="checkbox" class="label-toggle">
                <img src="{{ asset('images/icons/ic_moon.svg') }}" width="50%" class="ic-theme" id="ic-dark"
                    alt="Icon Dark" />
                <img src="{{ asset('images/icons/ic_sun.svg') }}" width="50%" class="ic-theme" id="ic-light"
                    alt="Icon Light" />
            </label>
        </div>
    </div>
    <p style="font-size: 15px">© 2022 Skripsicenter. All rights reserved.</p>
</footer>